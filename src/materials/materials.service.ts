...
export class MaterialsService {
  ...
  async removeStock(id: number) { const stock = await this.stocks.findOne({ where: { id } }); if (!stock) throw new NotFoundException('Existencia no encontrada.'); await this.stocks.delete(id); return { message: 'Material eliminado del área correctamente.' }; }
